...
export default function Flow({
      ...
      [
        ...
        },
        {
          ...
          data: {
            ...
            trigger: {
              taskIdentifier:
                "summarize-article" satisfies (typeof summarizeArticle)["id"],
              userTag: triggerUserTag,
            },
          },
        },
        {
          ...
          data: {
            ...
            trigger: {
              taskIdentifier:
                "convert-text-to-speech" satisfies (typeof convertTextToSpeech)["id"],
              userTag: triggerUserTag,
            },
          },
        },
        {
          ...
          data: {
            trigger: {
              taskIdentifier:
                "review-summary" satisfies (typeof reviewSummary)["id"],
              userTag: triggerUserTag,
            },
          },
        },
        {
          ...
          data: {
            ...
            trigger: {
              taskIdentifier:
                "publish-summary" satisfies (typeof publishSummary)["id"],
              userTag: triggerUserTag,
            },
          },
        },
  ...
  const [currentRunTag, setCurrentRunTag] = useState<string | undefined>(
    undefined
  );
